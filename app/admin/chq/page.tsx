...
function ChecklistManager() {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-xl font-bold">Checklist Items</h1>
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          <DialogTrigger asChild>
            <Button className="bg-blue-600 hover:bg-blue-700">
              <Plus className="w-4 h-4 mr-2" />
      ...
      <div className="grid gap-4">
        {items.length > 0 ? (
          ...
          <div className="py-6 text-center border rounded-md bg-gray-50">
            <p className="text-muted-foreground">No checklist items found. Click "Add Item" to create one.</p>
          </div>
        )}
      </div>
    </div>
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4">
        {benefits.length > 0 ? (
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-1 flex-1">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="font-medium">{benefit.benefit_name || "Untitled Benefit"}</h3>
                  </div>
                  {benefit.notes && (
                    <div className="flex items-center gap-2 mt-1">
                      <FileText className="h-3.5 w-3.5 text-gray-400" />
                      <p className="text-sm text-muted-foreground">{benefit.notes || "No notes provided"}</p>
                    </div>
                  )}
                </div>
                <div className="flex items-center gap-2 ml-2">
          ...
          <div className="py-6 text-center border rounded-md bg-gray-50">
            <p className="text-muted-foreground">No benefits found. Click "Add Benefit" to create one.</p>
          </div>
        )}
      </div>
    </div>
...
// MAIN COMPONENT
export default function AdminCHQPage() {
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
...
>>>>>>> 07a932c910494f776eec651bd1a2a65681669a0a
        ...
        <Button variant="outline" size="sm" asChild>
          <a href="/admin/chq/grid">Switch to Grid View</a>
        </Button>
      </div>

      <Tabs defaultValue="timeline" className="space-y-6">
        <TabsList className="bg-background border-b rounded-none w-full justify-start h-12 p-0 gap-6">
          <TabsTrigger 
            value="timeline" 
            className="data-[state=active]:bg-transparent data-[state=active]:border-b-2 data-[state=active]:border-blue-600 rounded-none h-12"
          >
            Timeline
          </TabsTrigger>
          <TabsTrigger 
