...
>>>>>>> 07a932c910494f776eec651bd1a2a65681669a0a
  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const filePath = `growth_machines/${fileName}`;
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
          <div className="max-w-md">
            ...
            <p className="text-gray-600 mb-6">
              {!machineData
                ? error
                : "Upload an image of your growth machine design to get started."}
            </p>
            ...
            {(hasImageContent && (!hasFigmaContent || showImageWhenFigmaExists)) ? (
              <div className="w-full h-full flex items-center justify-center p-4 sm:p-8">
                <img 
                  ...
                  alt={machineData?.enginename || "Growth Machine"} 
          ...
          <div className="">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-3">
              <div>
                ...
                <p className="text-xs sm:text-sm text-gray-500">
                  Manage your growth machine design and details
                </p>
              </div>
            </div>
